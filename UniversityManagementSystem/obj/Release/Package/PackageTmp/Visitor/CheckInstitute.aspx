...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <img src="Verified Institute.png" title="verify Institute" width="100"/>
      ...
      <br />  <label for="lbl_InstituteAff">Affiliated University: </label><asp:Label ID="lbl_InstituteAff" runat="server" /><br />
       ...
       <label for="lbl_InstituteAddress">Address: </label><asp:Label ID="lbl_InstituteAddress" runat="server" />,
        ...
        <div class="ins-date-box"><label for="lbl_InstituteAffDate">Date of Affiliation: </label><asp:Label ID="lbl_InstituteAffDate" runat="server" /></div>
   <label for="lbl_InstituteWeb">Website: </label>
        ...
        <!-- report form -->
                ...
                <asp:TextBox ID="tb_InstituteName" runat="server" PlaceHolder="InstituteName"></asp:TextBox><br />
