...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="tb_OldPass" runat="server" placeholder ="Old password"></asp:TextBox>
                    <br />
        <asp:TextBox ID="tb_NewPass" runat="server" placeholder ="New password"></asp:TextBox><br />
        <asp:TextBox ID="tb_NewPassConfirm" runat="server" placeholder ="New password"></asp:TextBox><br />
                    </asp:Panel>
        ...
        <hr /><br />
        <center>
            <asp:Label runat="server" ID="lbl_DegMsg" BackColor="Yellow" ForeColor="Black"></asp:Label><br />
        </center>
        ...
        <h2>Add new Student degree</h2>
            ...
            <asp:TextBox ID="tb_YearStarted" runat="server" placeholder="Year Started" TextMode="Number"></asp:TextBox><br />
            <asp:TextBox ID="tb_YearCompleted" runat="server" placeholder="Year Completed" TextMode="Number"></asp:TextBox><br />
            ...
            <asp:TextBox ID="tb_Contact" TextMode="Phone" runat="server"  placeholder="Phone"></asp:TextBox><br />
            <asp:TextBox ID="tb_Address" TextMode="MultiLine" runat="server" placeholder="Address"></asp:TextBox><br />
            <asp:FileUpload ID="fuc_Photo" runat="server" AllowMultiple="false" /><br />
            ...
            <asp:Button ID="btn_AddDegree" runat="server" Text="Add Degree" OnClick="btn_AddDegree_Click" /><br />
            </section>
        <br /><br /><br /><br /><br /><br />
    </form>
        </center>
