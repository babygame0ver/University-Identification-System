...
<body>
    <form id="form1" runat="server">
        ...
        <div class="form-switch-btn-container">
            ...
            <input type="button" value="Manage Programmes" id="addNewProg" />
...
<asp:ListItem value="West Bengal">West Bengal</asp:ListItem>
            ...
            <div class="email-con-box">
                ...
                <div class="contact-box">
                    ...
                    <asp:CheckBox ID="cb_TwoF" runat="server" Text="2(F)" />
                    <asp:CheckBox ID="cb_TweleveB" runat="server" Text="12(B)" />
            <br />
        ...
        <section id="RemoveInstitute">
            ...
            <asp:Button ID="btn_AddNewProgram" runat="server" Text="Add New Program" OnClick="btn_AddNewProgram_Click"/>
                ...
                <br />
                <label for="ddl_programmesList">Remove Programme: </label>
                <asp:DropDownList ID="ddl_programmesList" runat="server" DataSourceID="SqlDataSource1" DataTextField="Column1" DataValueField="Column1"></asp:DropDownList>
                <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:UISDBConnectionString %>' SelectCommand="select programmecode +' ------- '+programmename from ugcprogrammes order by ProgrammeCOde"></asp:SqlDataSource>
                <asp:Button ID="btn_RemoveProgramme" runat="server" Text="Remove Programme" OnClick="btn_RemoveProgramme_Click" />
                </div>
        </section>
    </form> 
</body>
